...
Subscription.prototype.changed = function(collectionName, id, changes) {
    if (this._hasDocChanged(collectionName, id, changes)) {
...
Subscription.prototype._removeDocHash = function(collectionName, docId) {
    delete this.docHash[this._buildHashKey(collectionName, docId)];
};

Subscription.prototype._buildHashKey = function(collectionName, docId) {
    return collectionName + "::" + docId.valueOf();
};
